...
| Release provenance + per-service SBOMs | Implemented | M34 | Dedicated build and release workflows with SLSA v1 provenance attestations, per-service CycloneDX SBOMs, cosign-signed checksums |
