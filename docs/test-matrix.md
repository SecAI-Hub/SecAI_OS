...
| Tool Firewall | services/tool-firewall/ | 16 | Default-deny egress policy, rule evaluation |
...
| test_agent.py | tests/ | 186 | Agent policy engine, task store, capabilities, execution, authentication, and service isolation |
...
| test_hardware_qualification.py | tests/ | 4 | Hardware qualification evidence generation |
