...
| 26 | Release provenance attestation | Build and release workflows | cosign attest with SLSA v1 provenance | CI workflow attestation step | Signed provenance attestation | `cosign verify-attestation --type slsaprovenance1 --key cosign.pub ghcr.io/secai-hub/secai_os@sha256:RELEASE_DIGEST` |
